    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6">
      <div className="max-w-lg text-center">
        ...
        <p className="text-sm text-[#5f5850] leading-relaxed mb-10">
          We&apos;ll follow up within a few hours with your rental agreement and insurance verification. The remaining balance is due 48 hours before your departure date.
        </p>
